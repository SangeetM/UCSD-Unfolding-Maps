...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {
		...
		*/
		...
		//Extension
		map1 = new UnfoldingMap(this, 200, 50, 650, 600, new Microsoft.AerialProvider());
	    map2 = new UnfoldingMap(this, 200, 50, 650, 600, new Microsoft.RoadProvider());
	...
	private void additionalKey() {
		...
		text("1: Microsoft Aerial", xbase+10, ybase+50);
		text("2: Microsft Road", xbase+10, ybase+65);
		text("3: Google Terrain", xbase+10, ybase+80 );
